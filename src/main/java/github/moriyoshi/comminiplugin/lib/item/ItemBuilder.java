...
public class ItemBuilder {
  ...
  public ItemBuilder name(final Object displayName) {
    return changeItemMeta(meta -> meta.displayName(BukkitUtil.mm(displayName)));
  }
  ...
  public ItemBuilder lore(@NotNull final List<?> lore) {
    return changeItemMeta(meta -> meta.lore(BukkitUtil.ListMM(lore)));
  }
  ...
  public ItemBuilder addLore(final Object... addLore) {
    ...
    lore.addAll(BukkitUtil.ListMM(Arrays.asList(addLore)));
    return lore(lore);
  }
  ...
  public ItemBuilder addLore(final List<?> addLore) {
    final List<Component> lore = getLore();
    lore.addAll(BukkitUtil.ListMM(addLore));
    return lore(lore);
  }
  ...
  public ItemBuilder insertLore(final int line, final Object str) {
    final List<Component> lore = getLore();
    lore.add(line, BukkitUtil.mm(str));
    return lore(lore);
  }
  ...
  public ItemBuilder setLore(final int line, final Object str) {
    ...
    while (lore.size() <= line) {
      lore.add(BukkitUtil.mm(" "));
    }
    lore.set(line, BukkitUtil.mm(str));
    return lore(lore);
  }
